...
export const LISTING_DETAILS = [
	{
		id: '0',
		title: 'Modern loft apartment',
		description: 'A stylish and unique space for family trips.',
		propertyType: 'Flat',
		address: 'Block B2, Sangotedo, Lekki, Lagos. 110011',
		price: 20,
		status: 'active',
		photos: [
	...
	},
	{
		...
		price: 15,
		status: 'active',
		photos: ['/images/apartment-placeholder.jpg', '/images/apartment-placeholder.jpg'],
		amenities: ['wifi', 'ac'],
		bookingType: 'request',
		houseRules: {
			smoking: false,
...
export function getListing(id) {
	return LISTING_DETAILS.find((l) => l.id === id);
}
