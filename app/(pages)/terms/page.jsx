	...
	return (
		<>
			...
			<main className='max-w-200 mx-auto px-6 py-16'>
				...
				<Para>
					Welcome to Orí Stays. The Terms of Service govern your use of our
					website, mobile application, and services. By creating an account,
					making a booking, or using our platform, you agree to these Terms. If
				...
				<Section
					...
					title='Booking Stays'>
					<Para>
						Our platform allows you to discover and book verified accommodation.
					</Para>
					...
					/>
					<Para>
						A reservation is only confirmed after successful payment and
						confirmation by the platform where applicable.
					</Para>
				</Section>
				...
				<Section
					...
					title='Ride Services'>
					<Para>
						Guests may book airport transfers and other ride services available
						on the platform.
					</Para>
					...
					/>
					<Para>
						Ride availability may vary depending on location and demand.
					</Para>
				</Section>
				...
				<Section
					...
					title='Payments'>
					<Para>
						Payments must be completed using the payment methods available on
						the platform.
					</Para>
					...
					/>
					<Para>
						Failure to complete payment may result in cancellation of your
						reservation.
					</Para>
				</Section>
				...
				<Section
					...
					<Para>
						Guests may request changes to their reservation, including:
					</Para>
					<List
						items={[
							'Check-in or check-out dates',
							'Number of guests',
							'Reserved apartment (where applicable)',
						]}
					/>
					<Para>
						Changes require approval from both parties before they take effect.
					</Para>
					<Para>
						Any additional charges resulting from the requested changes must be
						accepted before the reservation is updated.
					</Para>
				</Section>

				<Section
					number='7'
					title='Reservation Extensions'>
					<Para>
						If you wish to extend your stay, you may submit a request through
						the platform.
					</Para>
					...
					/>
					<Para>
						Your reservation is only extended once the request has been approved
						and payment has been completed where applicable.
					</Para>
				</Section>
				...
				<Section
					...
					<Para>
						Cancellation and refund eligibility depends on the cancellation
						policy associated with your booking.
					</Para>
					<Para>
						Where a refund applies, it will be processed using your original
						payment method.
					</Para>
					<Para>
						Some bookings or deposits may be non-refundable. Please review the
						cancellation policy before confirming your reservation.
					</Para>
				</Section>
				...
				<Section
					...
					/>
					<Para>
						You may be held responsible for damages caused during your stay or
						ride.
					</Para>
				</Section>
				...
				<Section
					...
					<Para>
						While we strive to keep our platform available at all times, we
				...
				<Section
					...
					<Para>
						We work to provide a reliable booking experience by partnering with
						verified hosts and service providers. However, we do not own or
						operate the listed properties or personally provide transportation
						services.
					</Para>
					<Para>
						To the extent permitted by law, our liability is limited to the
						amount you paid through the platform for the affected booking or
						ride.
					</Para>
					<Para>
				...
				<Section
					...
					<Para>
						Where significant changes are made, we will notify you through the
