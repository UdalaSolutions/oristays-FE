		...
		<>
			...
			<main className='max-w-3xl mx-auto px-6 py-16'>
				<div className='text-center mb-12'>
					...
					<p className='text-neutral-500 text-sm md:text-base leading-relaxed max-w-189 mx-auto'>
						Need assistance, have a question, or want to report an issue? Our
						support team is here to make sure your experience is smooth from
						start to finish. We&apos;re committed to resolving your concerns as
						quickly as possible.
					</p>
				</div>
				...
				<div className='text-center'>
					<p className='text-lg font-bold text-neutral-900 mb-6'>
						You can also contact us via:
					</p>
					<div className='flex items-center justify-center gap-6 flex-wrap'>
						<div className='flex items-center gap-3'>
							<div className='bg-white w-12.5 h-12.5 rounded-full flex items-center justify-center shrink-0 shadow-[0px_0px_25px_0px_#B5451B26]'>
								<Phone
									size={24}
									strokeWidth={1.5}
						...
						<div className='flex items-center gap-3'>
							...
							<a
								...
								className='text-lg font-medium text-neutral-800 hover:text-primary transition-colors'>
								oristays@support.ng
							</a>
						</div>
					</div>
